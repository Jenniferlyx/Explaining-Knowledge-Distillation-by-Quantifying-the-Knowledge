...
parser.add_argument("--model", type=str, default="vgg19") ## vgg11 vgg16 vgg19 resnet50 resnet101 resnet152 ##
parser.add_argument("--distilation_train", type=bool, default=True)
parser.add_argument("--classifier_train", type=bool, default=True)
parser.add_argument("--date", type=str, default="1020_supplement400")
...
parser.add_argument('--teacher_checkpoint', default='./KD/trained_model/ILSVRC_vgg19_augment_1020_supplement/800.pth.tar', type=str, metavar='PATH')
...
parser.add_argument("--epochs", type=int, default=400, help="number of distillation training iterations")
...
def distillation(path,args):
    ...
    if args.distilation_train:
        ...
        if args.scheduler:
            scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.3, patience=50, verbose=True)
